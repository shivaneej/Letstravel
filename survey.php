...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <a class="navbar-brand heading" href="home.php?status=loggedin">Letstravel</a>
    ...
    <form class="surveyForm">
	  	<div class="form-group category">
	    	...
	    	<div class="form-check">
  				<input class="form-check-input" type="checkbox" id="cat_Heri" value="1">
  				<label class="form-check-label" for="cat_AA">Heritage Sites</label>
			</div>
			<div class="form-check">
			  <input class="form-check-input" type="checkbox" id="cat_adv" value="2">
			  <label class="form-check-label" for="cat_adv">Activity and Adventure</label>
			</div>
			<div class="form-check">
			  <input class="form-check-input" type="checkbox" id="cat_BN" value="3">
	  	...
	  	<div class="form-group budget">
	    	...
	    	<div class="form-check">
  				<input class="form-check-input" type="checkbox" id="bud1" value="1">
  				<label class="form-check-label" for="bud1">Less than ₹5000</label>
			</div>
			<div class="form-check">
			  <input class="form-check-input" type="checkbox" id="bud2" value="2">
			  <label class="form-check-label" for="bud2">₹5000 - ₹20000</label>
			</div>
			<div class="form-check">
			  <input class="form-check-input" type="checkbox" id="bud3" value="3">
		...
		<div class="form-group accomGrp">
	    	...
	    	<div class="form-check">
  				<input class="form-check-input" type="checkbox" id="friends" value="1">
  				<label class="form-check-label" for="friends">My Friends</label>
			</div>
			<div class="form-check">
			  <input class="form-check-input" type="checkbox" id="family" value="2">
			  <label class="form-check-label" for="family">My Family</label>
			</div>
			<div class="form-check">
			  <input class="form-check-input" type="checkbox" id="partner" value="3">
		...
		<div class="form-group age">
	    	...
	    	<div class="form-check">
  				<input class="form-check-input" type="checkbox" id="kids" value="1">
  				<label class="form-check-label" for="kids">Less than 18</label>
			</div>
			<div class="form-check">
			  <input class="form-check-input" type="checkbox" id="adults" value="2">
			  <label class="form-check-label" for="adults">18 - 45</label>
			</div>
			<div class="form-check">
			  <input class="form-check-input" type="checkbox" id="senior" value="3">
		...
		<div class="form-group">
	      	<div class="form-check confirmBtn">
	        	<input class="form-check-input yellowBtn bottomBtn" type="submit" name="JoinTrip" value="Go!">
	      	</div>
	    </div>
	</form>
    <!--form ends-->
